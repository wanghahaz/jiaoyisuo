<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor: backgroundColor }" @click="onClick">
		...
		<!-- #endif -->
		<!-- #ifndef MP-ALIPAY -->
		<image src="../../static/images/gonggao.png" v-if="showClose === true || showClose === 'true'" class="gonggao uni-noticebar-close" type="closefill" :color="color" size="12" @click="close" ></image>
		<image src="../../static/images/gonggao.png" v-if="showIcon === true || showIcon === 'true'" class="gonggao uni-noticebar-icon" type="sound" :color="color" size="14"></image>
		<!-- #endif -->
