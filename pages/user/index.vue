<template>
	<view class="content">
		...
		<view class="userInfo">
				...
				<view>
					...
					<view>
						<view class="userName">
							...
							<image :src="centerData.level == 1 ? '../../static/images/vip_1-1.png' : centerData.level == 2 ? '../../static/images/vip_2-1.png' : '../../static/images/vip_3-1.png'"></image>
						</view>
						<view class="userId">UID： {{centerData.id}} <text :style="{color: centerData.checkStatus == 2 ? '' : '#fff', background: centerData.checkStatus == 2 ? '' : '#D8D8D8'}">{{centerData.checkStatus == 2 ? '已认证' : '未认证'}}</text></view>
					</view>
				</view>
			...
			<view class="quota">
				<view class="bg">
					<image src="../../static/images/my_bg.png" mode="aspectFill"></image>
				</view>
				<view>
					<view><text>每日提现：</text> 2BTC</view>
					<view><text>每日提现：</text> 4BTC</view>
					<view><text>每日提现：</text> 8BTC</view>
				</view>
				<view>
		...
		<view class="mybtn">
			<view class="item" @click="jump('entrust')"><!-- jump('entrust') showToast -->
